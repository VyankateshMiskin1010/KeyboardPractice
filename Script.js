...
const displayResult = () => {
  ...
  document.getElementById("restart-test").style.display = "block"; // Show Restart Test button
...
const restartTest = () => {
  ...
  document.getElementById("restart-test").style.display = "none"; // Hide Restart Test button
  document.getElementById("start-test").style.display = "block"; // Show Start Test button
